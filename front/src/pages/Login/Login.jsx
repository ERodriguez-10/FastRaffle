...
const Login = () => {
  ...
  return (
    <div className='container'>
      ...
      <Button onClickFunction={handleLogin} text={"<i style='background: rgb(255, 169, 136); font-size: 50px;' class='ri-discord-fill'><p style='background: rgb(255, 169, 136); display: inline-block; font-size: 20px'>Continuar con Discord</p></i>"} bg={"#ffa988"} className={"my-5"}/>
    </div>
  )
}
